...
const METHODS = new Set(['getState','prepareWallet','confirmWallet','cancelSetup','restoreWallet','unlock','lock','previewSend','confirmSend','newAddress','getRecoveryPhrase','exportWallet','saveConfig','setClaims','refresh','openExternal','copyAddress']);
let lastActivity = 0;
